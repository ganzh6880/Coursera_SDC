...
def get_closest_index(waypoints, ego_state):
    ...
    # ------------------------------------------------------------------
    for i in range(len(waypoints)):
        if math.sqrt((ego_state[0] - waypoints[i][0])**2 + (ego_state[1] - waypoints[i][1])**2) <= closest_len:
            closest_len = math.sqrt((ego_state[0] - waypoints[i][0])**2 + (ego_state[1] - waypoints[i][1])**2)
            closest_index = i
