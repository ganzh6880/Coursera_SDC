...
class Controller2D(object):
    ...
    def update_controls(self):
        ...
        """
        self.vars.create_var('v_previous', 0.0)
        self.vars.create_var('total_error', 0.0)
        ...
        if self._start_control_loop:
            ...
            e = v_desired - v
            total_error = self.vars.total_error + e * dt
            de = (e - self.vars.prev_error)/dt
        ...
        self.vars.total_error = total_error
        self.vars.prev_error = e
        self.vars.t_prev = t
